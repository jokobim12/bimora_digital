    ...
    <footer className="bg-stone-900 text-white">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-heading text-xl font-bold tracking-widest text-emerald-400">BIMORA</span>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-stone-800 hover:bg-emerald-600 text-stone-400 hover:text-white flex items-center justify-center transition-all cursor-pointer"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-stone-400 text-sm">
                ...
                <a href="https://wa.me/6281234567890" className="hover:text-emerald-400 transition-colors">+62 812-3456-7890</a>
              </li>
              <li className="text-stone-400 text-sm">
                <span className="block text-[10px] text-stone-500 uppercase tracking-wider mb-1">Instagram</span>
                <a href="https://instagram.com/jokobim12" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">@jokobim12</a>
              </li>
              <li className="text-stone-400 text-sm">
      ...
      <div className="border-t border-stone-800 py-4 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-stone-500 text-xs">
          ...
          <p>Dibuat dengan <IoHeart className="inline text-red-500 mx-1 align-text-bottom text-sm" /> oleh <a href="https://instagram.com/jokobim12" className="text-emerald-400 hover:underline">@jokobim12</a></p>
        </div>
      </div>
    </footer>
  )
