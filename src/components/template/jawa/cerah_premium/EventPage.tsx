  ...
  return (
    <div className={`w-full mx-auto px-6 py-12 lg:py-16 flex flex-col items-center transition-all duration-500 ${
      ...
      <div className={`w-full ${
        ...
        {/* Akad Nikah */}
        <div className="bg-white/80 border border-[#B38520]/20 rounded-2xl p-6 relative overflow-hidden reveal reveal-left delay-100 shadow-sm backdrop-blur-sm flex flex-col justify-between">
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#B38520] to-transparent" />
          
          <div>
            <h3 className="font-heading text-xl text-[#A17A24] text-center mb-5 tracking-wider">
              Akad Nikah
            </h3>
            
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <IoTimeOutline className="text-[#B38520] text-lg mt-0.5 flex-shrink-0" />
                <div className="font-body text-[11px] lg:text-[11.5px] leading-relaxed text-[#6B5A43]">
                  <span className="font-semibold block text-[#332211] text-xs mb-0.5">Waktu</span>
              ...
              <div className="flex items-start gap-3 mt-1">
                <IoLocationOutline className="text-[#B38520] text-lg mt-0.5 flex-shrink-0" />
                <div className="font-body text-[11px] lg:text-[11.5px] leading-relaxed text-[#6B5A43]">
                  <span className="font-semibold block text-[#332211] text-xs mb-0.5">Tempat</span>
                  {data.location_name}
                </div>
              </div>
            </div>
        ...
        {/* Resepsi */}
        <div className="bg-white/80 border border-[#B38520]/20 rounded-2xl p-6 relative overflow-hidden reveal reveal-right delay-300 shadow-sm backdrop-blur-sm flex flex-col justify-between">
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#B38520] to-transparent" />
      ...
      <div className={`w-full mt-12 reveal reveal-scale delay-200 ${
        isDesktopMode ? 'bg-[#FAF6EC]/40 border border-[#B38520]/15 p-6 rounded-2xl shadow-sm backdrop-blur-sm' : ''
      }`}>
        <p className="font-body text-[10px] tracking-[3px] uppercase text-[#B38520] mb-4 text-center">
          Petunjuk Lokasi
        </p>
        ...
        <div className={`w-full ${
          ...
          {/* Map box */}
          <div className="w-full h-[220px] lg:h-[260px] rounded-2xl border border-[#B38520]/25 overflow-hidden shadow-sm">
            <iframe
              src={data.maps_embed}
          ...
          <div className={`flex flex-col ${isDesktopMode ? 'text-left items-start px-2' : 'text-center items-center mt-6'}`}>
            <h4 className="font-heading text-lg text-[#A17A24] tracking-wide mb-3">{data.location_name}</h4>
            <p className="font-body text-[11px] lg:text-xs text-[#6B5A43] leading-relaxed mb-6">
              {data.location_address}
            </p>
            
            <a 
              className="inline-flex items-center gap-2 bg-[#B38520] hover:bg-[#9E7624] text-white font-body text-[10px] tracking-wider uppercase font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-sm active:scale-95 cursor-pointer"
              href={data.maps_link} 
              target="_blank" 
