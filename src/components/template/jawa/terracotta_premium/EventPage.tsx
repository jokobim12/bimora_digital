  ...
  return (
    <div className={`w-full mx-auto px-6 py-12 lg:py-16 flex flex-col items-center transition-all duration-500 ${
      ...
      <div className={`w-full ${
        ...
        {/* Akad Nikah */}
        <div className="bg-[#FAF6EC] border border-[#8B3D30]/20 rounded-2xl p-6 relative overflow-hidden reveal reveal-left delay-100 shadow-md flex flex-col justify-between text-[#5A1E17]">
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#8B3D30] to-transparent" />
          
          <div>
            <h3 className="font-heading text-xl text-[#5A1E17] text-center mb-5 tracking-wider font-bold">
              Akad Nikah
            </h3>
            
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <IoTimeOutline className="text-[#8B3D30] text-lg mt-0.5 flex-shrink-0" />
                <div className="font-body text-[11px] lg:text-[11.5px] leading-relaxed text-[#7A3227]">
                  <span className="font-semibold block text-[#5A1E17] text-xs mb-0.5 font-bold">Waktu</span>
              ...
              <div className="flex items-start gap-3 mt-1">
                <IoLocationOutline className="text-[#8B3D30] text-lg mt-0.5 flex-shrink-0" />
                <div className="font-body text-[11px] lg:text-[11.5px] leading-relaxed text-[#7A3227]">
                  <span className="font-semibold block text-[#5A1E17] text-xs mb-0.5 font-bold">Tempat</span>
                  {data.location_name}
                </div>
              </div>
            </div>
        ...
        {/* Resepsi */}
        <div className="bg-[#FAF6EC] border border-[#8B3D30]/20 rounded-2xl p-6 relative overflow-hidden reveal reveal-right delay-300 shadow-md flex flex-col justify-between text-[#5A1E17]">
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#8B3D30] to-transparent" />
      ...
      <div className={`w-full mt-12 reveal reveal-scale delay-200 ${
        isDesktopMode ? 'bg-[#FAF6EC] border border-[#8B3D30]/15 p-6 rounded-2xl shadow-md' : ''
      }`}>
        <p className="font-body text-[10px] tracking-[3px] uppercase text-[#8B3D30] mb-4 text-center font-semibold">
          Petunjuk Lokasi
        </p>
        ...
        <div className={`w-full ${
          ...
          {/* Map box */}
          <div className="w-full h-[220px] lg:h-[260px] rounded-2xl border border-[#8B3D30]/25 overflow-hidden shadow-sm">
            <iframe
              src={data.maps_embed}
          ...
          <div className={`flex flex-col ${isDesktopMode ? 'text-left items-start px-2' : 'text-center items-center mt-6'}`}>
            <h4 className="font-heading text-lg text-[#5A1E17] tracking-wide mb-3 font-bold">{data.location_name}</h4>
            <p className="font-body text-[11px] lg:text-xs text-[#7A3227] leading-relaxed mb-6">
              {data.location_address}
            </p>
            
            <a 
              className="inline-flex items-center gap-2 bg-[#8B3D30] hover:bg-[#5A1E17] text-white font-body text-[10px] tracking-wider uppercase font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-md active:scale-95 cursor-pointer"
              href={data.maps_link} 
              target="_blank" 
